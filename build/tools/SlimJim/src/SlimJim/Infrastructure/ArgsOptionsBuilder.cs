...
namespace SlimJim.Infrastructure
{
	public class ArgsOptionsBuilder
	{
        ...
        private static IList<string> FindProjects(string fileOrFolder)
        {
            ...
            return Directory.EnumerateFiles(fileOrFolder, "*.*", SearchOption.AllDirectories)
                .Where(s => s.EndsWith(".csproj", StringComparison.OrdinalIgnoreCase) || s.EndsWith(".jsproj", StringComparison.OrdinalIgnoreCase))
                .ToArray();
        }
