...
import DeliverStatHeaderLogoSmall from 'assets/images/DeliverStatHeaderLogo.png';
    ...
    render() {
        ...
        return (
            <div className={`app-sidebar d-none ${drawerStyle}`}>
                ...
                >
                <img src={DeliverStatHeaderLogoSmall} alt="DeliverSTAT" title="DeliverSTAT" className="side-nav-logo"/>
                    <SidenavContent/>
                </Drawer>
            </div>
        );
