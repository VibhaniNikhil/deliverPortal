            ...
            <div className="app-main-menu d-none d-md-block">
                <ul className="navbar-nav navbar-nav-mega">
                    ...
                    <li className="nav-item">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.jobs"/></a>
                        <ul className="sub-menu">

                            <li>
                                <NavLink to="/track">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.jobs.track"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/jobs">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.jobs.search"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/archive">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.jobs.archive"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/orders">
                                    ...
                                    <span className="nav-text"><IntlMessages id="sidebar.jobs.orders"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/pickups">
                                    <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.jobs.pickups"/></span>
                                </NavLink>
                            </li>
                    ...
                    <li className="nav-item">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.organization"/></a>
                        <ul className="sub-menu">

                            <li>
                                <NavLink to="/caregivers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.caregiver"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/customers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.customers"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/drivers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.drivers"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/network">
                                    <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.network"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/organizations">
                                    <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.organizations"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/users">
                                    <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.organization.users"/></span>
                                </NavLink>
                            </li>
                    ...
                    <li className="nav-item">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.help"/></a>
                        <ul className="sub-menu">

                            <li>
                                <NavLink to="/caregivers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.help.faqs"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/customers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.help.tutorials"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/drivers">
                                    <i className="zmdi zmdi-widgets zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.help.gethelp"/></span>
                                </NavLink>
                            </li>
                            ...
                            <li>
                                <NavLink to="/network">
                                    <i className="zmdi zmdi-trending-up zmdi-hc-fw"/>
                                    <span className="nav-text"><IntlMessages id="sidebar.help.history"/></span>
                                </NavLink>
                            </li>
                    ...
                    {/* <li className="nav-item mega-menu">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.components"/></a>
                    ...
                    <li className="nav-item">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.extensions"/></a>
                        <ul className="sub-menu">
                    ...
                    <li className="nav-item">
                        <a href="javascript:void(0)"><IntlMessages id="sidebar.extras"/></a>
                        <ul className="sub-menu">
